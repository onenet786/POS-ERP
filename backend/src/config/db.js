...
const mockStore = {
  ...
  companies: [
    ...
    {
      id: 2,
      name: 'Bin Ishaq Retail Mart',
      legal_name: 'Bin Ishaq Retail & Superstore Division',
      tax_id: 'NTN-7492019-3',
      strn: 'STRN-22-33-4455-666',
      phone: '+92 21 35050505',
      email: 'retail@binishaqsoft.com',
    ...
    {
      id: 3,
      name: 'Bin Ishaq Wholesale',
      legal_name: 'Bin Ishaq Wholesale & Regional Distribution',
      tax_id: 'NTN-7492019-4',
      strn: 'STRN-33-44-5566-777',
      phone: '+92 51 2223344',
      email: 'wholesale@binishaqsoft.com',
  ...
  booker_locations: [
    {
      ...
      latitude: 24.8607,
      longitude: 67.0011,
      human_location: 'Lyari Town, Karachi, Sindh',
      accuracy: 6.5,
      battery_level: 88,
      speed: 12.4,
      status: 'CHECKED_IN',
    ...
    },
    {
      ...
      latitude: 31.5204,
      longitude: 74.3587,
      human_location: 'Gulberg III, Lahore, Punjab',
      accuracy: 8.0,
      battery_level: 74,
      speed: 26.8,
      status: 'IN_TRANSIT',
